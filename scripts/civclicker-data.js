/*global
document, Resource, Building, Upgrade, Achievement, adjustMorale, population, digGraves, renameDeity,
updatePopulation, updateUpgrades, updateResourceTotals, updateResourceTotals, Unit, doSlaughter, doLoot,
curCiv, getCurDeityDomain, civSizes, doHavoc, playerCombatMods, wonderResources, indexArrayByAttr, CivObj
*/
...
function getCivData() {
    ...
    // Buildings
            ...
            new Upgrade({
                ...
                require: {
                    piety: 1000
                }, //xxx This is not fixed; see curCiv.graceCost
                init: function (fullInit) {
                    Upgrade.prototype.init.call(this, fullInit);
                    this.cost = 1000;
                },
            ...
            */
            ...
            new Achievement({
                ...
                name: "Ghost Town",
                test: function () {
                    return (population.living === 0 && population.limit >= 1000);
                }
            }),
                //deities
    ...
    function augmentCivData() {
        ...
        for (i = civSizes.length - 1; i > 0; i -= 1) {
